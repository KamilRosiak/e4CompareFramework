package de.tu_bs.cs.isf.e4cf.extractive_mple.editor_view.contribution;
...
import de.tu_bs.cs.isf.e4cf.extractive_mple.editor_view.handler.OpenInTreeViewHandler;
...
public class TreeProjectExplorerExtension implements IProjectExplorerExtension {
	...
	public Image getIcon(RCPImageService imageService) {
		return imageService.getImage(MPLEEditorConsts.BUNDLE_NAME, "icons/tree_view_icon.png");
	}
