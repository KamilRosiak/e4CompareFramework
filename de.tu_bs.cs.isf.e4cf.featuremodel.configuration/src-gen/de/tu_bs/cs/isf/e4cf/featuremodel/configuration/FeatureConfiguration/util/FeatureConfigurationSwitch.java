/**
 */
package de.tu_bs.cs.isf.e4cf.featuremodel.configuration.FeatureConfiguration.util;
...
public class FeatureConfigurationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FeatureConfigurationPackage.FEATURE_TO_BOOLEAN_MAP: {
				@SuppressWarnings("unchecked") Map.Entry<Feature, Boolean> featureToBooleanMap = (Map.Entry<Feature, Boolean>)theEObject;
				T result = caseFeatureToBooleanMap(featureToBooleanMap);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feature To Boolean Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Feature To Boolean Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFeatureToBooleanMap(Map.Entry<Feature, Boolean> object) {
		return null;
	}
