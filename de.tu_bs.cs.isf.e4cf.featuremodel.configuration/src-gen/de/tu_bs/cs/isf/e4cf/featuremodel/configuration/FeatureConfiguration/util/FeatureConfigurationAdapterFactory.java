...
public class FeatureConfigurationAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeatureConfigurationSwitch<Adapter> modelSwitch =
		new FeatureConfigurationSwitch<Adapter>() {
			...
			@Override
			public Adapter caseFeatureToBooleanMap(Map.Entry<Feature, Boolean> object) {
				return createFeatureToBooleanMapAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.e4cf.featuremodel.configuration.FeatureConfiguration.FeatureConfiguration <em>Feature Configuration</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>Feature To Boolean Map</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeatureToBooleanMapAdapter() {
		return null;
	}
