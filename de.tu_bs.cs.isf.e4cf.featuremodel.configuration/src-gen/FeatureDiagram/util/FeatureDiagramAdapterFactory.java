...
public class FeatureDiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected FeatureDiagramSwitch<Adapter> modelSwitch =
		new FeatureDiagramSwitch<Adapter>() {
			@Override
			public Adapter caseFeatureDiagramm(FeatureDiagramm object) {
				return createFeatureDiagrammAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGraphicalFeature(GraphicalFeature object) {
				return createGraphicalFeatureAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link FeatureDiagram.FeatureDiagramm <em>Feature Diagramm</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFeatureDiagrammAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link FeatureDiagram.GraphicalFeature <em>Graphical Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGraphicalFeatureAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link FeatureDiagram.ArtifactReference <em>Artifact Reference</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
