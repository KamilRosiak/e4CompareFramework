 ...
 * @generated
 */
public class MetricModelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MetricModelPackage.ABSTRACT_OPTION: {
				AbstractOption abstractOption = (AbstractOption)theEObject;
				T result = caseAbstractOption(abstractOption);
				if (result == null) result = caseAbstractMetricElement(abstractOption);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.ABSTRACT_ATTRIBUTE: {
				AbstractAttribute abstractAttribute = (AbstractAttribute)theEObject;
				T result = caseAbstractAttribute(abstractAttribute);
				if (result == null) result = caseAbstractMetricElement(abstractAttribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.ABSTRACT_METRIC_ELEMENT: {
				AbstractMetricElement abstractMetricElement = (AbstractMetricElement)theEObject;
				T result = caseAbstractMetricElement(abstractMetricElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MetricModelPackage.ABSTRACT_METRIC: {
	 ...
	 * @generated
	 */
	public T caseAbstractOption(AbstractOption object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Metric Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Metric Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractMetricElement(AbstractMetricElement object) {
		return null;
	}
