...
public class SequentialFunctionChartPackageImpl extends EPackageImpl implements SequentialFunctionChartPackage {
	 ...
	 */
	@Override
	public EReference getSimpleAction_Condition() {
	 ...
	 */
	@Override
	public EReference getComplexAction_PouVariable() {
		return (EReference)complexActionEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(simpleActionEClass, SIMPLE_ACTION__CONDITION);

		complexActionEClass = createEClass(COMPLEX_ACTION);
		createEReference(complexActionEClass, COMPLEX_ACTION__POU_ACTION);
		createEReference(complexActionEClass, COMPLEX_ACTION__POU_VARIABLE);
	...
	public void initializePackageContents() {
		...
		initEReference(getSimpleAction_Condition(), theConfigurationPackage.getVariable(), null, "condition", null, 1, 1, SimpleAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(complexActionEClass, ComplexAction.class, "ComplexAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComplexAction_PouAction(), theConfigurationPackage.getAction(), null, "pouAction", null, 1, 1, ComplexAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getComplexAction_PouVariable(), theConfigurationPackage.getVariable(), null, "pouVariable", null, 0, 1, ComplexAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
