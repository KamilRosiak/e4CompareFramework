...
public interface SequentialFunctionChartPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int SIMPLE_ACTION__CONDITION = ABSTRACT_ACTION_FEATURE_COUNT + 0;
	...
	/**
	 * The feature id for the '<em><b>Pou Variable</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int COMPLEX_ACTION__POU_VARIABLE = ABSTRACT_ACTION_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int COMPLEX_ACTION_FEATURE_COUNT = ABSTRACT_ACTION_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the reference '{@link de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.sequentialfunctionchart.SimpleAction#getCondition <em>Condition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Condition</em>'.
	 * @see de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.sequentialfunctionchart.SimpleAction#getCondition()
	 * @see #getSimpleAction()
	 * @generated
	 */
	EReference getSimpleAction_Condition();
	...
	/**
	 * Returns the meta object for the reference '{@link de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.sequentialfunctionchart.ComplexAction#getPouVariable <em>Pou Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Pou Variable</em>'.
	 * @see de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.sequentialfunctionchart.ComplexAction#getPouVariable()
	 * @see #getComplexAction()
	 * @generated
	 */
	EReference getComplexAction_PouVariable();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference SIMPLE_ACTION__CONDITION = eINSTANCE.getSimpleAction_Condition();
		...
		/**
		 * The meta object literal for the '<em><b>Pou Variable</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference COMPLEX_ACTION__POU_VARIABLE = eINSTANCE.getComplexAction_PouVariable();
