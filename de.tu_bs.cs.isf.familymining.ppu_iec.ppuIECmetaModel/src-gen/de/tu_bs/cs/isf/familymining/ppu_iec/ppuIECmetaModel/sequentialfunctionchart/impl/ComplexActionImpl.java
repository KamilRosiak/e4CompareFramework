 ...
 *   <li>{@link de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.sequentialfunctionchart.impl.ComplexActionImpl#getPouVariable <em>Pou Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexActionImpl extends AbstractActionImpl implements ComplexAction {
	...
	/**
	 * The cached value of the '{@link #getPouVariable() <em>Pou Variable</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPouVariable()
	 * @generated
	 * @ordered
	 */
	protected Variable pouVariable;
	 ...
	 */
	@Override
	public Variable getPouVariable() {
		if (pouVariable != null && ((EObject)pouVariable).eIsProxy()) {
			InternalEObject oldPouVariable = (InternalEObject)pouVariable;
			pouVariable = (Variable)eResolveProxy(oldPouVariable);
			if (pouVariable != oldPouVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SequentialFunctionChartPackage.COMPLEX_ACTION__POU_VARIABLE, oldPouVariable, pouVariable));
			}
		}
		return pouVariable;
	}
	 ...
	 * @generated
	 */
	public Variable basicGetPouVariable() {
		return pouVariable;
	}
	 ...
	 */
	@Override
	public void setPouVariable(Variable newPouVariable) {
		Variable oldPouVariable = pouVariable;
		pouVariable = newPouVariable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SequentialFunctionChartPackage.COMPLEX_ACTION__POU_VARIABLE, oldPouVariable, pouVariable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SequentialFunctionChartPackage.COMPLEX_ACTION__POU_VARIABLE:
				if (resolve) return getPouVariable();
				return basicGetPouVariable();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SequentialFunctionChartPackage.COMPLEX_ACTION__POU_ACTION:
				...
				return;
			case SequentialFunctionChartPackage.COMPLEX_ACTION__POU_VARIABLE:
				setPouVariable((Variable)newValue);
				return;
		}
