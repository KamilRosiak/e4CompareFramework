...
public class FXLoadFamilyModelDialog extends AbstractDialog {
	...
	public FXLoadFamilyModelDialog(String title, double width, double rowHeight) {
		this.title = title;
		this.width = width;
	...
	public void open() {
		...
		addFamilyModelResourceRow("Family Model Resource", "Select Resource");
	 ...
	 */
	private void addFamilyModelResourceRow(String name, String buttonName) {		
