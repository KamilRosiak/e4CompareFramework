/**
 */
package de.tu_bs.cs.isf.e4cf.family_model_view.prototype.model.Car.util;
...
public class CarAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.e4cf.family_model_view.prototype.model.Car.Car <em>Car</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.tu_bs.cs.isf.e4cf.family_model_view.prototype.model.Car.Wheel <em>Wheel</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
