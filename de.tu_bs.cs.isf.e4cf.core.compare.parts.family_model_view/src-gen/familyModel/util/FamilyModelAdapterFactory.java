...
public class FamilyModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected FamilyModelSwitch<Adapter> modelSwitch =
		new FamilyModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVariabilityGroup(VariabilityGroup object) {
				return createVariabilityGroupAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link familyModel.FamilyModel <em>Family Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link familyModel.VariabilityGroup <em>Variability Group</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVariabilityGroupAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link familyModel.Element <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
