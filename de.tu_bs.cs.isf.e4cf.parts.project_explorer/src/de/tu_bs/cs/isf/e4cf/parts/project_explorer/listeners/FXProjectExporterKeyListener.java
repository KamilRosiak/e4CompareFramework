...
public class FXProjectExporterKeyListener implements EventHandler<KeyEvent> {
	...
	KeyCombination kcRename = new KeyCodeCombination(KeyCode.Q, KeyCombination.CONTROL_DOWN);	
	
	
	public FXProjectExporterKeyListener(IEclipseContext  eclipseContext) {
