...
public class RemoveFileCommand {	
	...
	@Execute
	public void execute(Shell shell, RCPSelectionService selectionService, RCPImageService imageService, WorkspaceFileSystem fileSystem) {
		...
		boolean shouldDelete= RCPMessageProvider.questionMessage("Delete File(s)", DIALOG_MESSAGE + "\n\n" + filePathList);
		if (shouldDelete) {
			delete(selection);
		}
	}
