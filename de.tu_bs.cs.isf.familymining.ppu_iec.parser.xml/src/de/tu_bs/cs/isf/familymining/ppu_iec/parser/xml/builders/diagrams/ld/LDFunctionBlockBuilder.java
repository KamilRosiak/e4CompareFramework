...
import de.tu_bs.cs.isf.e4cf.parser.registry.Registry;
import de.tu_bs.cs.isf.e4cf.parser.registry.RegistryService;
import de.tu_bs.cs.isf.e4cf.parser.registry.iec.IECRegistry;
	...
	private FBDElement buildBasicFBDElement(ParserNode blockNode) {
		...
		if (isStandardFunctionBlock(typeName)) {
			...
			pouRegistry.performAction(typeName, pou -> {
				...
				fbdPou.setName("Ref: "+pou.getIdentifier());
			});
