...
class Test_TableServices {
	...
	void testCreateTable_columnNotNull() throws SQLException {
		...
		ts.switchColumnNotNull(_PATHTESTDATABASES, "testDB", "testTableNN", true, c1.getName());
	...
	void testDeleteColumn_normal() throws SQLException, IOException {
		...
		// System.out.print("Test: "+ ts.columnExists(_PATHTESTDATABASES, "testDB",
		// "testCn", c1.getName()));
	...
	void testAddColumn_columnPrimaryKey() throws SQLException {
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_PK", c1.getName())
				&& ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testAC_PK", c1.getName()));
		assertFalse(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_PK", c3.getName())
				&& ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testAC_PK", c3.getName()));
	}
	...
	void testAddColumn_columnUnique() throws SQLException {
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_Unique", c2.getName())
				&& ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testAC_Unique", c2.getName()));
		assertFalse(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_Unique", c3.getName())
				&& ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testAC_Unique", c3.getName()));
	}
	...
	void testAddColumn_columnAutoIncrement() throws SQLException {
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_AI", c2.getName())
				&& ts.isColumnAutoIncrement(_PATHTESTDATABASES, "testDB", "testAC_AI", c2.getName()));
		assertFalse(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_AI", c3.getName())
				&& ts.isColumnAutoIncrement(_PATHTESTDATABASES, "testDB", "testAC_AI", c3.getName()));
	}
	...
	void testAddColumn_columnNotNull() throws SQLException {
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_NN", c2.getName())
				&& ts.isColumnNotNull(_PATHTESTDATABASES, "testDB", "testAC_NN", c2.getName()));
		assertFalse(ts.columnExists(_PATHTESTDATABASES, "testDB", "testAC_NN", c3.getName())
				&& ts.isColumnNotNull(_PATHTESTDATABASES, "testDB", "testAC_NN", c3.getName()));
	}
	...
	void testRenameColumn() throws SQLException {
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testTableRC", "age_new")
				&& !ts.columnExists(_PATHTESTDATABASES, "testDB", "testTableRC", "age"));
		...
		assertTrue(ts.columnExists(_PATHTESTDATABASES, "testDB", "testTableRC", "age")
				&& !ts.columnExists(_PATHTESTDATABASES, "testDB", "testTableRC", "age_new"));
	...
	void testmakeColumnPrimaryKey() throws SQLException {
		...
		ts.switchColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testTableColumnPK", true, c1.getName(), c2.getName());
	...
	void testdropColumnPrimaryKey() throws SQLException {
		...
		ts.switchColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", false, c3.getName());
		...
		ts.switchColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", false, c1.getName());
		assertFalse(ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", c1.getName()));
		assertTrue(ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", c2.getName()));
		assertFalse(ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", c3.getName()));
		ts.switchColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", false, c2.getName());
		assertFalse(ts.isColumnPrimaryKey(_PATHTESTDATABASES, "testDB", "testDropColumnPK", c1.getName()));
	...
	void testmakeColumnAutoIncrement() throws SQLException {
		...
		ts.switchColumnAutoIncrement(_PATHTESTDATABASES, "testDB", "testmakeColumnAI", true, c1.getName());
	...
	void testdropColumnAutoIncrement() throws SQLException {
		...
		ts.switchColumnAutoIncrement(_PATHTESTDATABASES, "testDB", "testdropColumnAI", false, c1.getName());
		assertTrue(!ts.isColumnAutoIncrement(_PATHTESTDATABASES, "testDB", "testdropColumnAI", c1.getName()));
	...
	void testmakeColumnUnique() throws SQLException {
		...
		ts.switchColumnUnique(_PATHTESTDATABASES, "testDB", "testMakeColumnUnique", true, c1.getName());
		...
		ts.switchColumnUnique(_PATHTESTDATABASES, "testDB", "testMakeColumnUnique", true, c2.getName());
		assertTrue(ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testMakeColumnUnique", c1.getName()));
	...
	void testdropColumnUnique() throws SQLException {
		...
		ts.switchColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", false, c3.getName());
		...
		ts.switchColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", false, c1.getName());
		assertFalse(ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", c1.getName()));
		assertTrue(ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", c2.getName()));
		assertFalse(ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", c3.getName()));
		ts.switchColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", false, c2.getName());
		assertFalse(ts.isColumnUnique(_PATHTESTDATABASES, "testDB", "testDropColumnUnique", c1.getName()));
	...
	void testMakeColumnNotNull() throws SQLException {
		...
		ts.switchColumnNotNull(_PATHTESTDATABASES, "testDB", "testTableColumnNotNull", true, c1.getName());
		...
		ts.switchColumnNotNull(_PATHTESTDATABASES, "testDB", "testTableColumnNotNull", true, c3.getName());
		assertTrue(ts.isColumnNotNull(_PATHTESTDATABASES, "testDB", "testTableColumnNotNull", c1.getName()));
		assertFalse(ts.isColumnNotNull(_PATHTESTDATABASES, "testDB", "testTableColumnNotNull", c2.getName()));
	...
	void testDropColumnNotNull() throws SQLException {
		...
		ts.switchColumnNotNull(_PATHTESTDATABASES, "testDB", "testDropColumnNotNull", false, c3.getName());
		...
		ts.switchColumnNotNull(_PATHTESTDATABASES, "testDB", "testDropColumnNotNull", false, c1.getName());
