...
public class DataStructuresPropertiesController {
	private static final String TREE_VIEW_FXML = "ui/view/Properties.fxml";
	...
	public void postConstruct(Composite parent, ServiceContainer services, IEclipseContext context) {
		...
		FXMLLoader<PropertiesView> loader = new FXMLLoader<PropertiesView>(context, BUNDLE_NAME, TREE_VIEW_FXML);
