...
public class MatcherUtil {
    /**
     * This method returns all matcher that extending the de.tu_bs.cs.isf.e4cf.compare.Matcher extension point. 
     */
    public static List<Matcher> getAllMatcher() {
	List<Matcher> matcher = RCPContentProvider.<Matcher>getInstanceFromBundle(CompareST.MATCHER_SYMBOLIC_NAME, CompareST.MATCHER_EXTENSION);
	if(matcher != null) {
		return matcher;
	}
