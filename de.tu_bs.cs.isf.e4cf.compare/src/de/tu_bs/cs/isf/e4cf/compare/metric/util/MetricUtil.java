...
public class MetricUtil {
	...
	File file = new File(RCPContentProvider.getCurrentWorkspacePath() + CompareST.METRICS_FOLDER + "/" + metric.getMetricName()+"."+CompareST.FILE_ENDING_METRIC);
	...
	if(!path.equals("")) {
		...
		try {
			...
			RCPMessageProvider.errorMessage("Warning", "The following Metric , "+metricName+", has not been found");
		}
		return loadedUnit;	
	}
	return null;
