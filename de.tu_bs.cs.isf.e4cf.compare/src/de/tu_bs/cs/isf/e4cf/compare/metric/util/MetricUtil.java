...
public class MetricUtil {
	...
	File file = new File(RCPContentProvider.getCurrentWorkspacePath() + CompareST.METRICS_FOLDER + "/"
		+ metric.getMetricName() + "." + CompareST.FILE_ENDING_METRIC);
	...
	if (choice == 1) {
	    ...
	    if (inputChoice == 0) {
		file = new File(RCPContentProvider.getCurrentWorkspacePath() + CompareST.METRICS_FOLDER + "/"
