...
import de.tu_bs.cs.isf.e4cf.graph.GraphFactory;
...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @see de.tu_bs.cs.isf.e4cf.graph.GraphPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getGraph_Graph() {
	 ...
	 */
	@Override
	public EAttribute getGraphicElement_Width() {
	 ...
	 */
	@Override
	public EAttribute getGraphicElement_Height() {
	 ...
	 */
	@Override
	public EAttribute getGraphicElement_XPostion() {
	 ...
	 */
	@Override
	public EAttribute getGraphicElement_YPostion() {
		return (EAttribute)graphicElementEClass.getEStructuralFeatures().get(3);
	}
	...
	public void createPackageContents() {
		...
		createEReference(graphEClass, GRAPH__GRAPH);
		...
		createEAttribute(graphicElementEClass, GRAPHIC_ELEMENT__WIDTH);
		createEAttribute(graphicElementEClass, GRAPHIC_ELEMENT__HEIGHT);
		createEAttribute(graphicElementEClass, GRAPHIC_ELEMENT__XPOSTION);
		createEAttribute(graphicElementEClass, GRAPHIC_ELEMENT__YPOSTION);
	}
	...
	public void initializePackageContents() {
		...
		graphicElementEClass.getESuperTypes().add(this.getNode());
		...
		initEReference(getGraph_Graph(), this.getNode(), null, "graph", null, 0, -1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGraphicElement_Width(), ecorePackage.getEDoubleObject(), "width", "0", 1, 1, GraphicElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGraphicElement_Height(), ecorePackage.getEDoubleObject(), "height", "0", 1, 1, GraphicElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGraphicElement_XPostion(), ecorePackage.getEDoubleObject(), "xPostion", "0", 1, 1, GraphicElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGraphicElement_YPostion(), ecorePackage.getEDoubleObject(), "yPostion", "0", 1, 1, GraphicElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
