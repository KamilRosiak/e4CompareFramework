...
public class TaxonomyController {
	...
	public void postConstruct(Composite parent, ServiceContainer services, IEclipseContext context) throws IOException {
        ...
        FXMLLoader<TaxonomyControlView> loader = new FXMLLoader<TaxonomyControlView>(context, "de.tu_bs.cs.isf.e4cf.core.compare.parts.taxonomy_control_view", TAXONOMY_CONTROL_VIEW_FXML);
