 ...
 * @generated
 */
public class FeatureDiagramModificationSetSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public FeatureDiagramModificationSetSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case FeatureDiagramModificationSetPackage.FEATURE_MODEL_MODIFICATION_SET: {
				FeatureModelModificationSet featureModelModificationSet = (FeatureModelModificationSet)theEObject;
				T result = caseFeatureModelModificationSet(featureModelModificationSet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeatureDiagramModificationSetPackage.MODIFICATION: {
				Modification modification = (Modification)theEObject;
				T result = caseModification(modification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeatureDiagramModificationSetPackage.DELTA: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feature Model Modification Set</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Feature Model Modification Set</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFeatureModelModificationSet(FeatureModelModificationSet object) {
		return null;
	}
...
} //FeatureDiagramModificationSetSwitch
