...
@Singleton
@Creatable
public class AddAttributeValueEventHandler extends EventHandlerBase {

	@Inject
	public AddAttributeValueEventHandler(ClusterEngine clusterEngine) {
		super(clusterEngine);
	...
	public void handleEvent(Event event) {
		...
		Value value = (Value) event.getProperty(DSEditorST.VALUE);
		CloneModel cloneModel = (CloneModel) event.getProperty(DSEditorST.CLONE_MODEL);
		
		cloneModel.addAttributeValue(selectedNode, attribute, value);
