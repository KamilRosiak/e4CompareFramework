...
public class FDStringTable {
	public static final String BUNDLE_NAME = "de.tu_bs.cs.isf.e4cf.featuremodel.core";
	
	/**
	 * Preferences 
	 */
	
	public static final String FME_THEME_KEY ="FME_THEME_KEY";
	
	public static final String CONSTRAINT_VIEW ="de.tu_bs.cs.isf.e4cf.featuremodel.constraint_view";
	 ...
	 */
	public static final String FD_BAR_MENU_NEW_DIAGRAM = "New Diagram";
	public static final String FD_BAR_MENU_SAVE = "Save";
	public static final String FD_BAR_MENU_LOAD = "Load";
	public static final String FD_BAR_MENU_FORMAT_DIAGRAM = "Format Diagram";
	 ...
	 * FILE ENDINGS
	 */
	public static final String FD_FILE_ENDING =".fm";
	public static final String FD_CHANGE_SEQUENCE_FILE_ENDING =".fdco";
