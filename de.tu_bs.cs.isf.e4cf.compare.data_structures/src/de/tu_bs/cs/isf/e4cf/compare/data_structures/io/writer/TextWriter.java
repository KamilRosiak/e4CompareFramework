...
import de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.text.TextFileTags;
import de.tu_bs.cs.isf.e4cf.core.util.file.FileStreamUtil;

/**
 * This class realizes the transformation of the tree data structure back into
 * the origin format. In this case its transforms a instance of the class @see
 * Tree into an text file.
 * 
 * @author Kamil Rosiak
 *
 */
public class TextWriter extends AbstractArtifactWriter {
	...
	/**
	 * This method transforms a Tree of type TEXT back into a string that represents
	 * the origin file.
	 * 
	 * @param tree
	 * @return
