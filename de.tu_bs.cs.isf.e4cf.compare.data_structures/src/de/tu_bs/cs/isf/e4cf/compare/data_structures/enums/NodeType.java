...
public enum NodeType {
	...
	VARIABLE_DECLARATOR, CONFIGURATION, COMPONENT, PACKAGE, MODEL, // UML types
	ASSOCIATION, INTERFACE_UML, INTERFACE_REALIZATION, // UML types
	PROPERTY, OPERATION, GENERALIZATION, ELEMENT_IMPORT, DATA_TYPE, PARAMETER, // UML types
	LITERAL_STRING, LITERAL_INTEGER, LITERAL_UNLIMTED_NATURAL, ENUMERATION_LITERAL, LITERAL_BOOLEAN,
	IMPORTED_ELEMENT,
	...
	// ARCH TYPES
	ARCH_FILE, ARCH_ARCHITECTURE, ARCH_SIGNAL, ARCH_COMPONENT, ARCH_PORT, ARCH_CONNECTOR, ARCH_OWNED_COMMENT, ARCH_ATTRIBUTE, ARCH_CONTENT
	;
