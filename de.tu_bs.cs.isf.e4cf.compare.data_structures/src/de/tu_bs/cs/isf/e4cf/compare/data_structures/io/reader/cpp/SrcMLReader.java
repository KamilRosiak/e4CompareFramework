...
import de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.cpp.adjust.AdjustAll;
...
public class SrcMLReader extends AbstractArtifactReader {
	...
	public static String[] SUPPORTED_FILE_ENDINGS = { Const.CPP };
	...
	private Node readArtifactRoot(FileTreeElement element) {
		...
		try {
			...
			if (inputStream != null) {
				...
				rootNode.getChildren().get(0).addAttribute(new AttributeImpl(Const.NAME_BIG, new StringValueImpl(fileName)));
