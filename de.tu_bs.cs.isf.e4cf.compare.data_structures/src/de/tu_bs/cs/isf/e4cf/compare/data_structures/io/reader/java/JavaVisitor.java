package de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.java;
...
import de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.java.factory.JavaReaderUtil;
import de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.java.factory.NodeFactory;
import de.tu_bs.cs.isf.e4cf.compare.data_structures.io.reader.java.templates.AbstractJavaVisitor;
...
public class JavaVisitor extends AbstractJavaVisitor {
	...
	/**
	 * Creates a new node for the assert statement of type {@link AssertStmt} as a string
	 * 
	 * @see <a href=
	 ...
	 * {@link ConditionalExpr} (aka Ternary) and adds subtrees wrapped in containers
	 * 
	 * @see <a href=
