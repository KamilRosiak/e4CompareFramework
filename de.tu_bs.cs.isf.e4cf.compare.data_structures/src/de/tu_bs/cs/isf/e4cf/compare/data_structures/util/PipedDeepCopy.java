...
/**
 * Utility for making deep copies (vs. clone()'s shallow copies) of objects in a
 * memory efficient way. Objects are serialized in the calling thread and
...
public class PipedDeepCopy {
	...
	private static class Deserializer extends Thread {
		...
		/**
		 * Returns the deserialized object. This method will block until the object is
		 * actually available.
		 */
