package de.tu_bs.cs.isf.e4cf.compare.data_structures.io.unittest.roundtrip;
 ...
 * resources/test/roundtrip Must be run as JUnit Plug-In Test TODO: Validate
 * Reader
 */
public class RoundtripTests {
	...
	private void testSuite(String suite) {
		...
		for (String scenario : scenarios) {
			assertTrue("Scenario Failure: " + suite + scenario, testScenario(suite, scenario));
		}
